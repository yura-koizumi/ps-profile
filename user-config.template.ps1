...
# PowerShell 上で pconfig を実行すると、このファイルを開けます。
#
...
# starship は起動を軽くするため既定では無効。必要な場合だけ有効化します。
# $global:PSProfileEnableStarship = $true
...
# ── psprofile-update の取得元を上書き (PR / 検証ブランチ / 社内 fork など) ──
